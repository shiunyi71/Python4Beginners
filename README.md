...
| [Week 06](https://github.com/shiunyi71/Python4Beginners/issues/18) | [**流程控制(下) - 程式的重複魔法！打造尋寶冒險遊戲**](https://homepage.ntu.edu.tw/~jfanc/Marp/HP06_Flow_Control_02/)<br>• while與for迴圈結構<br>• break與continue應用<br>• 運用while迴圈製作遊戲主循環<br>• 使用for迴圈處理道具清單<br>• 加入計分系統與遊戲存檔功能 | [操作練習](https://drive.google.com/file/d/17jXFvf14rwYrO6pyd0qtirrr1lFfHB7B/view?usp=sharing)<br>[HW3](https://docs.google.com/forms/d/e/1FAIpQLSe8bmXRs6Kl7A4Gend8HtOv3gf2SnBVvPuosw8dAM7NY-8I5g/viewform) |
| Week 07 | **資料容器(上) - 清單的魔法世界！成為寶物收集家**<br>• 清單(List)的基本概念<br>• 清單的新增、刪除、修改操作<br>• 清單切片與索引使用<br>• 建立寶物收集系統<br>• 實作新增寶物功能與搜尋功能 | [操作練習]() |
| Week 08 | **資料容器(下) - 字典的奧秘寶庫！打造遊戲背包系統**<br>• 字典(Dictionary)基礎概念<br>• 字典的鍵值配對操作<br>• 字典的新增、刪除、修改方法<br>• 設計物品屬性結構<br>• 建立物品分類與數量管理系統 | [操作練習]()<br>HW4 |
| Week 09 | **函式設計(上) - 打造程式積木樂園！建立魔法咒語庫**<br>• 函式的基本概念與定義<br>• 參數傳遞的基礎用法<br>• 函式回傳值的運用<br>• 設計基礎魔法函式<br>• 製作參數可調整的咒語 | [操作練習]() |
| Week 10 | **課程檢視、回顧與統整**<br>第6-9週課程內容複習與問題解答 | |
| Week 11 | **函式設計(下) - 模組的無限可能！創造程式工具箱**<br>• 模組的概念與使用方法<br>• 自定義模組的建立<br>• 模組的匯入與應用<br>• 使用Matplotlib繪製圖表<br>• 運用Tkinter製作GUI介面 | [操作練習]()<br>HW5 |
| Week 12 | **檔案處理(上) - 探索資料祕密花園！製作個人日記系統**<br>• 檔案讀寫基礎概念<br>• 文字檔案的開啟與關閉<br>• 檔案讀取與寫入操作<br>• 建立日記檔案結構<br>• 實作日記撰寫與搜尋功能 | [操作練習]() |
| Week 13 | **檔案處理(下) - 資料分析小達人！建立成績管理系統**<br>• CSV檔案格式介紹<br>• Pandas基礎操作<br>• 資料分析入門技巧<br>• 讀取CSV成績資料<br>• 計算平均與排名，繪製統計圖表 | [操作練習]()<br>HW6 |
